...
interface NameDeleteSaveClickListener {
    ...
    fun addAndPostMeal(mealName : String, proteins: String, carbs: String, fats: String , uId: String?, mealProteinInput: EditText, mealCarbsInput: EditText, mealFatsInput: EditText)
}